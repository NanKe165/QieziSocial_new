...
public class CaptureButton extends View {
    ...
    private int progress_color = 0xFFF5C657;            //进度条颜色
    private int outside_color = 0xA1F5C657;      //A160C48E       //外圆背景色
    private int inside_color = 0xFFF5C657;    //FF60C48E            //内圆背景色
    ...
    public CaptureButton(Context context, int size) {
        ...
        button_inside_radius = button_radius * 0.9f;
...
//        canvas.drawCircle(center_X, center_Y, button_outside_radius, mPaint);
        ...
        canvas.drawArc(this.rectF, -90, 360, false, mPaint);
        ...
        if (state == STATE_RECORDERING) {
            ...
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setStrokeWidth(strokeWidth);
            canvas.drawArc(this.rectF, -90, progress, false, mPaint);
        }
    }
