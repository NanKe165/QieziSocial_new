...
public class CameraParamUtil {
    ...
    public Camera.Size getPictureSize(List<Camera.Size> list, int th, float rate) {
        ...
        int i = 0;
        for (Camera.Size s : list) {
            Log.i(TAG, "rate "+ rate +"MakeSure Picture :w = " + s.width + " h = " + s.height);
            if ((s.width > th) && equalRate(s, rate)) {
...
//            Log.i(TAG, "getBaseSize: rate:" + rate + "  prop:" + prop + " previewDisparity:" + previewDisparity);
//            Log.i(TAG, "getBaseSize:   w:" + list.get(index).width + "  h:" + list.get(index).height);
//            Log.i(TAG, "getBaseSize: rate:" + rate + "  prop:" + prop + " previewDisparity:" + previewDisparity);
        ...
        Log.i(TAG, "getBaseSize: index:" + index + "  w:" + list.get(index).width + "  h:" + list.get(index).height);
