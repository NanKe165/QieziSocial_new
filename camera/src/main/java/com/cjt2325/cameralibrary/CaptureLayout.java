...
public class CaptureLayout extends FrameLayout {
    ...
    public CaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        button_size = (int) (layout_width / 3.5f);
    ...
    public void initEvent() {
        ...
        img_confirm.setVisibility(GONE);
    }
...
//        btn_capture.setVisibility(GONE);
        ...
        btn_capture.setFocusable(false);
...
//        set.start();
        ...
        img_confirm.setVisibility(VISIBLE);
        img_cancel.setClickable(false);
        img_confirm.setClickable(false);
        ObjectAnimator a_cancel = ObjectAnimator.ofFloat(img_cancel, "translationX", 0, layout_width / 4);
        ObjectAnimator a_confirm = ObjectAnimator.ofFloat(img_confirm, "translationX", 0, layout_width / 5*2);

        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playTogether(a_cancel, a_confirm);
        animatorSet.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
                img_cancel.setClickable(true);
                img_confirm.setClickable(true);
            }
        });
    ...
    private void initView() {
        ...
        hintTxt = new TextView(getContext());
        hintTxt.setText("长按");
        hintTxt.setTextColor(Color.WHITE);
        hintTxt.setTextSize(18);
//        hintTxt.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        hintTxt.setVisibility(GONE);
        hintTxt.setGravity(Gravity.CENTER);
        LayoutParams hint_param = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        hint_param.gravity = Gravity.CENTER;
        hintTxt.setLayoutParams(hint_param);
...
//                resetCaptureLayout();
        ...
        //取消按钮2
        img_cancel = new ImageView(getContext());
        img_cancel.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.image_cancel));
        final LayoutParams img_cancel_param = new LayoutParams(ScreenUtils.dip2px(getContext(), 30), ScreenUtils.dip2px(getContext(), 30));
        img_cancel_param.gravity = Gravity.CENTER;
        img_cancel.setLayoutParams(img_cancel_param);
        ...
        //确认按钮2
        img_confirm = new ImageView(getContext());
        img_confirm.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.img_confirm));
        LayoutParams img_confirm_param = new LayoutParams(ScreenUtils.dip2px(getContext(), 40), ScreenUtils.dip2px(getContext(), 40));
        img_confirm_param.gravity = Gravity.CENTER;
        img_confirm.setLayoutParams(img_confirm_param);
...
//        txt_tip.setText("轻触拍照，长按摄像");
        ...
        this.addView(img_cancel);
        this.addView(img_confirm);
        this.addView(hintTxt);
    ...
    public void setHintVisiable(boolean visiable){
        if (visiable)
