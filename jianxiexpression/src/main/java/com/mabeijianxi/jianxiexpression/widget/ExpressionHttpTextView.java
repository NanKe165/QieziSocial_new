...
import com.mabeijianxi.jianxiexpression.widget.http.HttpTextView;

/**
 * Created by jian on 2016/6/24.
 * mabeijianxi@gmail.com
 */
public class ExpressionHttpTextView extends HttpTextView {
    ...
    public ExpressionHttpTextView(Context context) {
        super(context);
        init(null);
    }

    public ExpressionHttpTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ExpressionHttpTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mExpressionAlignment =  DynamicDrawableSpan.ALIGN_BASELINE;
        } else {
