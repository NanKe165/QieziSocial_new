...
public class TxVideoPlayerController
    ...
    private void init() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.tx_video_palyer_controller, this, false);
        addView(view);        
    ...
    public void canClick(boolean canClick){
        if (!canClick) {
            ...
            mRestartPause.setOnClickListener(null);
            mFullScreen.setOnClickListener(null);
            mClarity.setOnClickListener(null);
//            mRetry.setOnClickListener(this);
//            mReplay.setOnClickListener(this);
    ...
    public void setControllerClickListener(OnClickListener clickListener){
        this.setOnClickListener(clickListener);
    }
    public void setFullScreenListener(OnClickListener clickListener){
        this.mFullScreen.setOnClickListener(clickListener);
    }
...
//            }
            ...
            if (mNiceVideoPlayer.isFullScreen()) {
                ...
                if(onModeChangeListener != null){
                    onModeChangeListener.onExitFullScreen();
                }
    ...
    public void pauseOrPlay(){
        if (mNiceVideoPlayer.isPlaying() || mNiceVideoPlayer.isBufferingPlaying()) {
            mNiceVideoPlayer.pause();
            mCenterStart.setVisibility(View.VISIBLE);
        } else if (mNiceVideoPlayer.isPaused() || mNiceVideoPlayer.isBufferingPaused() || isRestart) {
            mNiceVideoPlayer.restart();
            mCenterStart.setVisibility(View.GONE);
            isRestart = false;
