 ...
 * 播放器
 */
public class HomeVideoPlayer extends FrameLayout
    ...
    public HomeVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public void start() {
        ...
        if (mCurrentState == STATE_IDLE) {
            openMedia = true;
            NiceVideoPlayerManager.instance().setHomeNiceVideoPlayer(this);
            initAudioManager();
            initMediaPlayer();
            initTextureView();
            addTextureView();
