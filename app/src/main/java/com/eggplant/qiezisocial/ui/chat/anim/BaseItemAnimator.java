...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public boolean animateRemove(final ViewHolder holder) {
        Log.i("BaseItemAnimator","animateRemove");
    ...
    public boolean animateChange(@NonNull ViewHolder oldHolder, @NonNull ViewHolder newHolder, @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
        Log.i("BaseItemAnimator","animateChange");
    ...
    public boolean animateAdd(final ViewHolder holder) {
        Log.i("BaseItemAnimator","animateAdd");
        resetAnimation(holder);
    ...
    public boolean animateMove(final ViewHolder holder, int fromX, int fromY,
                               int toX, int toY) {
        Log.i("BaseItemAnimator","animateMove");
        final View view = holder.itemView;
    ...
    public void endAnimation(ViewHolder item) {
        Log.i("BaseItemAnimator","endAnimation");
    ...
    public void endAnimations() {
        Log.i("BaseItemAnimator","endAnimations");
