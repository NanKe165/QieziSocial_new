...
public class TestLayoutManager extends RecyclerView.LayoutManager implements
     ...
     * helps {@link TestLayoutManager} make those decisions.
     */
     ...
     */
    public TestLayoutManager(Context context, @RecyclerView.Orientation int orientation,
     ...
     */
    public TestLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                             int defStyleRes) {
    ...
    private Map<Integer, Integer> locas = new HashMap();
...
//
        ...
        if (wes1.containsKey(i)) {
            we1 = wes1.get(i);
            if (itemCount!=1&&!wes1.containsKey(itemCount)){
                resetWes1(i);
        ...
        if (wes2.containsKey(i)) {
            we2 = wes2.get(i);
            if (itemCount!=1&&!wes2.containsKey(itemCount)){
                resetWes2(i);
        ...
        if (rotations.containsKey(i)) {
            ...
            if (itemCount!=1&&!rotations.containsKey(itemCount)){
                resetRotation(i);
        ...
        if (locas.containsKey(i)) {
            layoutLoca = locas.get(i);
            if (itemCount!=1&&!locas.containsKey(itemCount)){
                resetLocas(i);
                int nextLoca = locas.get(i + 1);
                if (nextLoca==0){
                    layoutLoca=1;
                }else {
                    layoutLoca=0;
                }
                locas.put(i,layoutLoca);
            }
        } else {
            if (locas.containsKey(i-1)){
                int lastLoca = locas.get(i - 1);
                if (lastLoca==0){
                    layoutLoca = 1;
                }else {
                    layoutLoca = 0;
        ...
        layoutDecorated(view, itemX, top, itemX + width, bottom);

        if (rotation == 0) {
            view.setRotation(-10.0F*we2 );
        } else {
            view.setRotation(10.0F *we2);
        }
    ...
    private void resetWes1(int i) {
        for (int j=getItemCount();j>i;j--){
            if (wes1.containsKey(j-1)){
                Float lastWe=wes1.get(j-1);
                wes1.put(j,lastWe);
            }
        }
    }

    private void resetWes2(int i) {
        for (int j=getItemCount();j>i;j--){
            if (wes2.containsKey(j-1)){
                Float lastWe=wes2.get(j-1);
                wes2.put(j,lastWe);
            }
        }
    }

    private void resetRotation(int i) {
        for (int j=getItemCount();j>i;j--){
            if (rotations.containsKey(j-1)){
                int lastRota=rotations.get(j-1);
                rotations.put(j,lastRota);
            }
        }
    }


    private void resetLocas(int i) {
        for (int j=getItemCount();j>i;j--){
            if (locas.containsKey(j-1)){
                int lastLoca=locas.get(j-1);
                locas.put(j,lastLoca);
            }
        }
    }
    ...
    private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
            new ViewBoundsCheck.Callback() {
                ...
                public int getChildCount() {
                    return TestLayoutManager.this.getChildCount();
                }
                ...
                public View getChildAt(int index) {
                    return TestLayoutManager.this.getChildAt(index);
                }

                @Override
                public int getParentStart() {
                    return TestLayoutManager.this.getPaddingLeft();
                }

                @Override
                public int getParentEnd() {
                    return TestLayoutManager.this.getWidth() - TestLayoutManager.this.getPaddingRight();
                }
                ...
                public int getChildStart(View view) {
                    ...
                    return TestLayoutManager.this.getDecoratedLeft(view) - params.leftMargin;
                }
                ...
                public int getChildEnd(View view) {
                    final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                            view.getLayoutParams();
                    return TestLayoutManager.this.getDecoratedRight(view) + params.rightMargin;
                }
            };
    /**
    ...
    private final ViewBoundsCheck.Callback mVerticalBoundCheckCallback =
            new ViewBoundsCheck.Callback() {
                ...
                @Override
                public int getParentStart() {
                    return TestLayoutManager.this.getPaddingTop();
                }

                @Override
                public int getParentEnd() {
                    return TestLayoutManager.this.getHeight()
                            - TestLayoutManager.this.getPaddingBottom();
                }
                ...
                public int getChildStart(View view) {
                    final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                            view.getLayoutParams();
                    return TestLayoutManager.this.getDecoratedTop(view) - params.topMargin;
                }
                ...
                public int getChildEnd(View view) {
                    final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                            view.getLayoutParams();
                    return TestLayoutManager.this.getDecoratedBottom(view) + params.bottomMargin;
                }
            };
