...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.tv_gray3;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = QzApplication.Companion.get().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = QzApplication.Companion.get().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
    ...
    public boolean onTouchEvent(TextView widget, Spannable buffer,
        ...
        if(action == MotionEvent.ACTION_DOWN){
            ...
            widget.setBackgroundResource(R.color.translate);
