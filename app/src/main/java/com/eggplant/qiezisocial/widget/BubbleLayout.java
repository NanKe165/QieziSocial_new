...
public class BubbleLayout extends FrameLayout {
    ...
    private boolean trangle_visiable;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //背景颜色
        int backGroundColor = ta.getColor(R.styleable.BubbleLayout_buble_bg_color, Color.WHITE);
        //阴影颜色
        ...
        trangle_visiable = ta.getBoolean(R.styleable.BubbleLayout_triangle_visiable, false);
