...
public class EmojiEmoticonsKeyBoard extends AutoHeightLayout implements FuncLayout.OnFuncChangeListener, View.OnClickListener, ExpressionEditText.OnBackKeyClickListener {
    ...
    public EmojiEmoticonsKeyBoard(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void inflateKeyboardBar() {
        mInflater.inflate(R.layout.layout_emoji_panel, this);
    }
