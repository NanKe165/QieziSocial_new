package com.eggplant.qiezisocial.widget.scrollPicker.adapter;
...
import com.eggplant.qiezisocial.widget.scrollPicker.IPickerViewOperation;
import com.eggplant.qiezisocial.widget.scrollPicker.IViewProvider;
import com.eggplant.qiezisocial.widget.scrollPicker.provider.DefaultItemViewProvider2;

import java.util.ArrayList;
import java.util.List;

public class ScrollPickerAdapter2<T> extends RecyclerView.Adapter<ScrollPickerAdapter2.ScrollPickerAdapterHolder> implements IPickerViewOperation {
    ...
    public ScrollPickerAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (mViewProvider == null) {
            mViewProvider = new DefaultItemViewProvider2(mContext);
        }
...
//        adaptiveItemViewSize(itemView);
    ...
    public static class ScrollPickerAdapterBuilder<T> {
        ...
        public ScrollPickerAdapterBuilder(Context context) {
            mAdapter = new ScrollPickerAdapter2<T>(context);
        }
