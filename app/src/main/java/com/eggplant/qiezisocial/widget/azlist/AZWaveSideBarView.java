...
import com.eggplant.qiezisocial.utils.TextDrawUtils;
...
public class AZWaveSideBarView extends View {
    ...
    private void initAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = typeArray.getColor(R.styleable.AZWaveSideBarView_backgroundColor, Color.parseColor("#00F9F9F9"));
        mStrokeColor = typeArray.getColor(R.styleable.AZWaveSideBarView_strokeColor, Color.parseColor("#00000000"));
        mTextColor = typeArray.getColor(R.styleable.AZWaveSideBarView_textColor, Color.parseColor("#000000"));
