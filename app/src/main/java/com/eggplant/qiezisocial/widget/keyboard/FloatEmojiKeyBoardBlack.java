...
public class FloatEmojiKeyBoardBlack extends AutoHeightLayout implements FuncLayout.OnFuncChangeListener, View.OnClickListener, ExpressionEditText.OnBackKeyClickListener {
    ...
    public FloatEmojiKeyBoardBlack(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void inflateKeyboardBar() {
        mInflater.inflate(R.layout.layout_float_emoji_panel2, this);
    }
...
//        });
    ...
    public void reset() {
        ...
        emojiFace.setImageResource(R.mipmap.emoji_face_white);
        emojiAudio.setImageResource(R.mipmap.emoji_audio_white);
    }
    ...
    public void onFuncChange(int key) {
        if (FUNC_TYPE_EMOJI == key) {
            emojiFace.setImageResource(R.mipmap.emoji_keyboard_white);
            emojiAudio.setImageResource(R.mipmap.emoji_audio_white);
        } else if (FUNC_TYPE_AUDIO == key){
            emojiAudio.setImageResource(R.mipmap.emoji_keyboard_white);
            emojiFace.setImageResource(R.mipmap.emoji_face_white);
        }else {
            emojiFace.setImageResource(R.mipmap.emoji_face_white);
            emojiAudio.setImageResource(R.mipmap.emoji_audio_white);
