package com.eggplant.qiezisocial.utils.selectabletxt;
...
//        });
    ...
    OnSelectTextClickListener mNoteBookClickListener;
    public void setSelectListener(OnSelectListener selectListener) {
        mSelectListener = selectListener;
    }

    public void setOnNotesClickListener(OnSelectTextClickListener notesClickListener) {
        ...
        public OperateWindow(final Context context) {
            ...
            contentView.findViewById(R.id.tv_copy).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                    TipsUtil.INSTANCE.showToast(mContext,"已复制到剪切板");
                }
            });
            ...
            contentView.findViewById(R.id.tv_note).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mNoteBookClickListener != null) {
                        mNoteBookClickListener.onMultSelectClick(mSelectionInfo.mSelectionContent);
                    }
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                }
            });
            contentView.findViewById(R.id.tv_del).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mNoteBookClickListener != null) {
                        mNoteBookClickListener.onDelClick();
                    }
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                }
