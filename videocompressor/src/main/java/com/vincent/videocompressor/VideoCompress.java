...
public class VideoCompress {
     ...
     * @return
     */
    public static VideoCompressTask compressVideoFixed(String srcPath, String destPath, CompressListener listener) {
        VideoCompressTask task =  new VideoCompressTask(listener, VideoController.COMPRESS_QUALITY_FIXED);
        task.execute(srcPath, destPath);
        return task;
    }
